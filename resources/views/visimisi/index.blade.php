	...
	<body>
		...
		<div class="main-wrapper">
			...
			<div style="background-color : #b3daf6"class="container">
				<h2 class="text-uppercase" style="text-align: center;">Visi Misi</h2>
			</div>
			<section class="about-area pt-30 pb-30" style="padding-bottom: px;">
              ...
              @foreach($visi_misi as $visimisi)
                ...
                <div class="col-sm-6">
                  <div class="row"
										style="padding-left:20px; font-size:16px;padding-right:20px;">
                ...
                <div class="col-sm-6">
                  <div class="row"
										style="padding-left:20px; font-size:16px;padding-right:20px;">
                    <p style="text-align: justify;">{{$visimisi->misi}}</p>
                  </div>
                </div>

								<!-- untuk mengedit atau menambahkan visi misi -->
                <!-- <script src="{{URL::asset('storage/ckeditor/ckeditor.js')}}"></script>

                <form  action="/visimisi/create" method="POST">
                  {{csrf_field()}}
                  <form>
