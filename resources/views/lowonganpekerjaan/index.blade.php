	...
	<body>
		...
		<div class="main-wrapper">
			<div style="background-color : #b3daf6" class="container">
				<h2 class="text-uppercase" style="text-align: center;">Lowongan Pekerjaan</h2>
			</div>
	<section class="about-area pt-30 pb-30" style="padding-bottom: 0px;">

				<div class="container">


					<div class="row align-items-center justify-content-between">
						<div class="col-lg-12 col-md-12 col-sm-12 about-right">
              @foreach($data_lowonganpekerjaan as $lowongan)
							<div class="row" style="padding:5px;" >
								<div class="col-sm-4">
									<!-- foto pekerjaan -->
									<a href="/lowonganpekerjaan"><img src="storage/teknisi.jpg" alt="" style="width:200px; height:200px;"></a>
              ...
              @endforeach
					...
					@foreach($data_lowonganpekerjaan as $lowongan)
					<div class="modal fade" id="{{$lowongan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

						<div class="modal-dialog" role="document">
						  <div class="modal-content">
						    <div class="modal-header">

						      <h5 class="modal-title" id="exampleModalLabel">{{$lowongan->nama_pekerjaan}}</h5>
